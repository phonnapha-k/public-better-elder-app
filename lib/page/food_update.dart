...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return new MaterialApp(
        debugShowCheckedModeBanner: false, home: FoodInsertDone());
  }
}

///This program is use to taking picture and detail for daily journal  of meal in Better Elder Application.
///   , this FoodInsertDonePage is an first page of FoodInsertDone insert, it's implement FoodInsertDoneInsert class to insert meal photo
///This FoodInsertDone program have 2 sub class there are FoodInsertDone class and _FoodInsertDoneState Class
///FoodInsertDone Class is calling _FoodInsertDoneState Class only to show the Widget
///_FoodInsertDoneState Class is implement 1 method there is build method to build context in Widget
///
/// Author:Phonnapha.K
/// Date:May 31, 2024
///
///This class show Widget of this FoodInsertDonePage that is the first page of FoodInsertDone insert
class FoodInsertDone extends StatefulWidget {
  @override
  State<FoodInsertDone> createState() => _FoodInsertDoneState();
}
...
///
class _FoodInsertDoneState extends State<FoodInsertDone> {
